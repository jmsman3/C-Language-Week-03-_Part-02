...
int main()
{
    ...
    for (int i = 0; i < p; i++)
    {
        ...
        student sorbocchoNumberPabe = 
        student1.findSorbocchoNumber(student2).findSorbocchoNumber(student3);
        cout << sorbocchoNumberPabe.id << " " << sorbocchoNumberPabe.name << " " 
        << sorbocchoNumberPabe.section << " " << sorbocchoNumberPabe.totalmarks << endl;
    }
